...
namespace DataBase
{
    public class Connection
    {
        ...
        /// </summary>
        /// <param name="tipo">Tipo do log</param>
        public static void SetArtefatosOrigem(string caminho)
        {
            banco.SetArtefatosOrigem(caminho);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static string GetArtefatosOrigem()
        {
            return banco.GetArtefatosOrigem();
        }
        ...
        /// </summary>
        /// <param name="tipo">Tipo do log</param>
        public static void SetArtefatosDestino(string caminho)
        {
            banco.SetArtefatosDestino(caminho);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static string GetArtefatosDestino()
        {
            return banco.GetArtefatosDestino();
        }
        ...
        /// </summary>
        /// <param name="tipo">Tipo do log</param>
        public static void SetCaminhoFilePararRobo(string caminho)
        {
            banco.SetCaminhoFilePararRobo(caminho);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static string GetCaminhoFilePararRobo()
        {
            return banco.GetCaminhoFilePararRobo();
        }
        ...
        /// </summary>
        /// <param name="tipo">Tipo do log</param>
        public static void SetCaminhoFileIniciaRobo(string caminho)
        {
            banco.SetCaminhoFileIniciaRobo(caminho);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static string GetCaminhoFileIniciaRobo()
        {
            return banco.GetCaminhoFileIniciaRobo();
        }
        ...
        /// </summary>
        /// <param name="tipo">Tipo do log</param>
        public static void SetCaminhoFileReiniciaRobo(string caminho)
        {
            banco.SetCaminhoFileReiniciaRobo(caminho);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static string GetCaminhoFileReiniciaRobo()
        {
            return banco.GetCaminhoFileReiniciaRobo();
        }
        ...
        /// </summary>
        /// <param name="tipo">Tipo do log</param>
        public static void SetCaminhoFileReiniciaVM(string caminho)
        {
            banco.SetCaminhoFileReiniciaVM(caminho);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static string GetCaminhoFileReiniciaVM()
        {
            return banco.GetCaminhoFileReiniciaVM();
        }
